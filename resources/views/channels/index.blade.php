...
@section('content')
    <h4 class="page-title mr-2 d-none">Canaux</h4>
    <a href="{{action('ChannelController@create')}}"><button type="button" class="btn btn-secondary btn-xs mb-2" title="Ajouter">+ Ajouter un canal</button></a>
    <div class="row">
