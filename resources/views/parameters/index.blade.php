...
@section('content')
    ...
    <h4 class="page-title d-inline-block mr-2">Paramètres</h4>
    <a href="{{action('ParameterController@create')}}"><button type="button" class="btn btn-secondary btn-xs mb-1" title="Ajouter">+ Ajouter</button></a>
